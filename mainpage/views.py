...
def tcpage(request):
   return render(request,"tcpage.html")
...
def submitcontact(request):
      if request.method == "POST":  
         ...
         new_contact = contacts(fname=first_name, lname=last_name, email=email, review=review,date=date, message=message)
         new_contact.save()
         return HttpResponse("YOUR FORM WILL BE SUBMITTED")